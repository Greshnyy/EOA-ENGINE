...
public:
    ...
    bool IsInCategory(EventCategory cat) const {
        return (category_ & static_cast<int>(cat)) != 0;
    }
...
public:
    WindowCloseEvent() 
        : Event(EventType::WindowClose, "WindowClose", EventCategory::Application) {}
...
public:
    WindowResizeEvent(int width, int height)
        : Event(EventType::WindowResize, "WindowResize", EventCategory::Application),
...
public:
    WindowFocusEvent() 
        : Event(EventType::WindowFocus, "WindowFocus", EventCategory::Application) {}
};

class WindowLostFocusEvent : public Event {
public:
    WindowLostFocusEvent() 
        : Event(EventType::WindowLostFocus, "WindowLostFocus", EventCategory::Application) {}
};

class WindowMoveEvent : public Event {
public:
    WindowMoveEvent(int x, int y)
        : Event(EventType::WindowMove, "WindowMove", EventCategory::Application),
          x_(x), y_(y) {}
...
public:
    KeyPressedEvent(KeyCode keycode, int repeatCount = 0, int modifiers = 0)
        : Event(EventType::KeyPressed, "KeyPressed", EventCategory::Input),
          keycode_(keycode), repeatCount_(repeatCount), modifiers_(modifiers) {}
...
public:
    KeyReleasedEvent(KeyCode keycode)
        : Event(EventType::KeyReleased, "KeyReleased", EventCategory::Input),
          keycode_(keycode) {}
...
public:
    KeyTypedEvent(unsigned int unicode)
        : Event(EventType::KeyTyped, "KeyTyped", EventCategory::Input),
          unicode_(unicode) {}
...
public:
    MouseButtonPressedEvent(MouseButton button, float x, float y, int modifiers = 0)
        : Event(EventType::MouseButtonPressed, "MouseButtonPressed", EventCategory::Input),
          button_(button), x_(x), y_(y), modifiers_(modifiers) {}
...
public:
    MouseButtonReleasedEvent(MouseButton button, float x, float y)
        : Event(EventType::MouseButtonReleased, "MouseButtonReleased", EventCategory::Input),
...
public:
    MouseMovedEvent(float x, float y, float deltaX, float deltaY)
        : Event(EventType::MouseMoved, "MouseMoved", EventCategory::Input),
...
public:
    MouseScrolledEvent(float xOffset, float yOffset)
        : Event(EventType::MouseScrolled, "MouseScrolled", EventCategory::Input),
...
public:
    ActorSpawnedEvent(Actor* actor)
        : Event(EventType::ActorSpawned, "ActorSpawned", EventCategory::World),
          actor_(actor) {}
...
public:
    ActorDestroyedEvent(uint64_t actorId)
        : Event(EventType::ActorDestroyed, "ActorDestroyed", EventCategory::World),
          actorId_(actorId) {}
...
public:
    ComponentAddedEvent(Actor* actor, Component* component)
        : Event(EventType::ComponentAdded, "ComponentAdded", EventCategory::World),
          actor_(actor), component_(component) {}
...
public:
    ComponentRemovedEvent(Actor* actor, Component* component)
        : Event(EventType::ComponentRemoved, "ComponentRemoved", EventCategory::World),
          actor_(actor), component_(component) {}
...
public:
    LevelLoadedEvent(const std::string& levelName)
        : Event(EventType::LevelLoaded, "LevelLoaded", EventCategory::World),
...
public:
    LevelUnloadedEvent(const std::string& levelName)
        : Event(EventType::LevelUnloaded, "LevelUnloaded", EventCategory::World),
          levelName_(levelName) {}
...
public:
    ResourceLoadedEvent(const std::string& resourceName, void* resource)
        : Event(EventType::ResourceLoaded, "ResourceLoaded", EventCategory::Resource),
          resourceName_(resourceName), resource_(resource) {}
...
public:
    ResourceUnloadedEvent(const std::string& resourceName)
        : Event(EventType::ResourceUnloaded, "ResourceUnloaded", EventCategory::Resource),
...
public:
    CustomEvent(const std::string& name, std::any data = nullptr)
        : Event(EventType::Custom, name, EventCategory::Custom),
          data_(std::move(data)) {}
...
public:
    ...
    void AddListener(IEventListener* listener, EventCategory categories = EventCategory::None) {
        ...
        ListenerInfo info{listener, categories};
    ...
    void Dispatch(Event& event) {
        ...
        for (auto& info : listeners_) {
            ...
            if (info.categories == EventCategory::None || 
                event.IsInCategory(info.categories)) {
